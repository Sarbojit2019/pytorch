...
message(STATUS  "inside LoadHip.cmake")
...
message(STATUS "MAGMA_HOME : ${MAGMA_HOME}")
...
message("Building PyTorch for GPU arch: ${PYTORCH_ROCM_ARCH}")
  ...
  message("For CHIP Arch info is not needed")
endif()
...
if(NOT USE_CHIP)
  ...
  if(USE_CHIP)
    find_library(PYTORCH_HIP_LIBRARIES CHIP HINTS ${ROCM_PATH}/lib)
  else()
